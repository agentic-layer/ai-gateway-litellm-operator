...
const serviceAccountName = "ai-gateway-litellm-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "ai-gateway-litellm-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "ai-gateway-litellm-controller-manager-metrics-binding"

// clusterRoleMetricsReader is the name of the ClusterRole that allows reading metrics
const clusterRoleMetricsReader = "ai-gateway-litellm-metrics-reader"
